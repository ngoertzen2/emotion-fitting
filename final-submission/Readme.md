...
Two pre-generated datasets are included to help you test the pipeline without collecting your own webcam samples:

`small_sample_data.pkl` - 5 sample faces (1 person)

`large_sample_data.pkl` - 22 sample faces (7 people)